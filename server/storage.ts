...
export interface IStorage {
  ...
  markContactSubmissionProcessed(id: number): Promise<ContactSubmission | undefined>;
}
...
export class MemStorage implements IStorage {
  ...
  async markContactSubmissionProcessed(id: number): Promise<ContactSubmission | undefined> {
    const submission = this.contactSubmissions.get(id);
    if (submission) {
      const updatedSubmission = { ...submission, isProcessed: true };
